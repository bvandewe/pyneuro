...
class LabInstancesController(ControllerBase):
    ...
    async def update_lab_instance(
        self,
        lab_instance_id: str,
        update_dto: UpdateLabInstanceDto
    ) -> LabInstanceDto:
        ...
        try:
            ...
            if (current_instance.status.phase == LabInstancePhase.PENDING and 
                update_dto.scheduled_start_time is not None):
                ...
                raise HTTPException(
                    status_code=400, 
                    detail="Lab instance cannot be updated in current phase"
                )
    ...
    async def delete_lab_instance(self, lab_instance_id: str):
        ...
        try:
            ...
            if instance.status.phase == LabInstancePhase.RUNNING:
                raise HTTPException(
                    status_code=400,
                    detail="Cannot delete running lab instance"
                )
    ...
    async def start_lab_instance(self, lab_instance_id: str) -> LabInstanceDto:
        ...
        try:
            ...
            instance.spec.scheduled_start_time = datetime.utcnow()
    ...
    async def stop_lab_instance(self, lab_instance_id: str) -> LabInstanceDto:
        ...
        try:
            ...
            raise HTTPException(
                status_code=501,
                detail="Stop operation not yet implemented"
            )
    ...
    async def get_lab_instance_logs(
        ...
        try:
            ...
            if not instance.status.container_id:
                raise HTTPException(
                    status_code=400,
                    detail="Lab instance has no associated container"
                )
