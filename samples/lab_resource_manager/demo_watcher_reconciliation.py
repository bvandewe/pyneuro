...
from samples.lab_resource_manager.integration.services.container_service import (
    ContainerService
)
...
class WatcherReconciliationDemo:
    ...
    def __init__(self):
        ...
        # Repository
        self.repository = LabInstanceResourceRepository(
            self.storage,
            self.serializer
        )
    ...
    async def create_sample_resource(self, name: str, start_delay_minutes: int = 0) -> LabInstanceRequest:
        ...
        status = LabInstanceRequestStatus(
