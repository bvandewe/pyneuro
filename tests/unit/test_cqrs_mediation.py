...
class TestCQRSScenarios:
    ...
    async def test_create_duplicate_user_command(self):
        ...
        # Create first user
        await self.user_repository.add_async(TestUser(
            id="1",
    ...
    async def test_list_users_query(self):
        ...
        # Add test users
        users = [
            TestUserDto(id="1", email="user1@example.com", first_name="User", last_name="One", 
                       full_name="User One", is_active=True),
            TestUserDto(id="2", email="user2@example.com", first_name="User", last_name="Two", 
                       full_name="User Two", is_active=False),
            TestUserDto(id="3", email="user3@example.com", first_name="User", last_name="Three", 
                       full_name="User Three", is_active=True)
        ]
