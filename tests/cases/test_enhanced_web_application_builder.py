"""
Tests for EnhancedWebApplicationBuilder - Advanced web application builder with multi-app support.

This test suite validates the enhanced web application builder functionality including
...
class TestEnhancedWebApplicationBuilder:
    ...
    def test_build_processes_pending_controller_modules(self):
        ...
        with patch.object(self.builder, '_register_controllers_to_app') as mock_register:
            ...
            remaining_pending = [reg for reg in self.builder._pending_controller_modules 
                               if reg.get("app") is None]
